...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Feb 2024 pada 03.24
...
(3, 'XII TKJ', 'Teknik Komputer dan Jaringan'),
(4, 'XII Farm', 'Ilmu Farmasi'),
(5, 'XII DKV', 'Desain Komunikasi Visual'),
(6, 'XII MM', 'Multimedia');
...
(35, 1, '12345', '2024-02-15', 'Februari', '2024', NULL, 100000),
(36, 1, '12346', '2024-02-16', 'Februari', '2024', NULL, 100000),
(39, 1, '12348', '2024-02-15', 'Februari', '2024', NULL, 50000);
...
('12345', '1001', 'Iwan', 1, 'Pangkalan Bun', '081254566574', NULL, '827ccb0eea8a706c4c34a16891f84e7b'),
('12346', '1002', 'Eko', 3, 'Sidorejo', '081257102890', NULL, 'a3590023df66ac92ae35e3316026d17d'),
('12347', '1003', 'Budianto', 5, 'Sampit', '084756298126', NULL, '8a13dab3f5ec9e22d0d1495c8c85e436'),
('12348', '1004', 'Dewi Lestari', 4, 'PalangkaRaya', '081257102176', NULL, 'ee25f924b7df4d4fb93b3da96ee342b1');
...
ALTER TABLE `pembayaran`
  ...
  ADD KEY `nisn` (`nisn`),
  ADD KEY `fk_pembayaran_id_spp` (`id_spp`);
...
ALTER TABLE `siswa`
  ...
  ADD KEY `fk_siswa_id_spp` (`id_spp`);
...
--
ALTER TABLE `pembayaran`
  ADD CONSTRAINT `fk_pembayaran_id_spp` FOREIGN KEY (`id_spp`) REFERENCES `spp` (`id_spp`),
...
--
ALTER TABLE `siswa`
  ADD CONSTRAINT `fk_siswa_id_spp` FOREIGN KEY (`id_spp`) REFERENCES `spp` (`id_spp`),
