...
if(isset($_POST['id_petugas'])) {
    ...
    $query = mysqli_query($koneksi, "INSERT INTO pembayaran(id_petugas,nisn,tgl_bayar,jumlah_bayar,bulan_dibayar,tahun_dibayar) values ('$id_petugas','$nisn','$tgl_bayar','$jumlah_bayar','$bulan_dibayar','$tahun_dibayar') ");
			...
			<div class="card-body">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td width="1">:</td>
                        <td>
                           <select name="bulan_dibayar" class="form-select">
                    ...
                    <tr>
                        ...
                        <td width="1">:</td>
                        <td>
                            <input class="form-control" type="number" name="tahun_dibayar">
                        </td>
                    </tr>
